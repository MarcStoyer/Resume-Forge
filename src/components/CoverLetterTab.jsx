    ...
    <div className="max-w-4xl mx-auto p-5 space-y-4">
        ...
        <div className="flex items-center gap-2 mt-2 flex-wrap">
          ...
          {coverLetter && (
            <>
              ...
              <button onClick={() => exportCoverLetterDocx(coverLetter, resume.contact)} className="px-3 py-1.5 rounded-md text-xs font-medium border border-stone-300 hover:bg-stone-50">⬇ Export DOCX</button>
              <button onClick={() => window.print()} className="px-3 py-1.5 rounded-md text-xs font-medium border border-stone-300 hover:bg-stone-50">🖨 Print/PDF</button>
            </>
          )}
      ...
      <div className="bg-white rounded-lg border border-stone-200 p-6 print-area">
        <textarea
          ...
          className="w-full text-sm border-none outline-none resize-none leading-relaxed font-serif"
