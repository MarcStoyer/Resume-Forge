...
export const DEFAULT_PROFILE =
  "I am a quantitatively trained generalist with a Columbia astrophysics background and a strong hands-on, build-oriented bent. I combine applied Python data-engineering experience with practical fabrication and field skills, and I am comfortable moving between rigorous analysis and physical, real-world problem solving.";
...
export function defaultResume() {
  return {
    ...
    sections: [
      {
        id: "exp", title: "Experience", kind: "entries", addLabel: "+ Add job", removable: false,
        entries: [
          {
            id: uid(), on: true,
            org: "Amplify Endowment Management", loc: "[City / Remote]",
            role: "[Title — e.g., Business Development Associate]", dates: "[Start] – Present",
      ...
      {
        id: "edu", title: "Education", kind: "entries", addLabel: "+ Add school", removable: false,
        entries: [
          {
            id: uid(), on: true,
            ...
            bullets: [
              ...
              b("Relevant coursework: Electrodynamics, Order-of-Magnitude Physics", "DATA", false),
            ],
          },
        ],
      },
      {
        id: "skills", title: "Technical Skills", kind: "list", addLabel: "+ Add skill line", removable: false,
        entries: [
          ...
          { id: uid(), on: true, tag: "ANALYSIS", label: "Quantitative", text: "Probability & statistics" },
          { id: uid(), on: true, tag: "IMPACT", label: "Fabrication & Hardware", text: "Welding, electronics, robotics, prototyping" },
        ],
      },
      {
        id: "certs", title: "Certifications", kind: "list", addLabel: "+ Add certification", removable: false,
        entries: [
      ...
      {
        id: "awards", title: "Honors & Awards", kind: "list", addLabel: "+ Add award", removable: false,
        entries: [
          { id: uid(), on: false, tag: "IMPACT", label: "", text: "[Award or scholarship — e.g., Dean's List, [Name] Scholarship]" },
        ],
      },
      {
        id: "proj", title: "Projects & Builds", kind: "list", addLabel: "+ Add project", removable: false,
        entries: [
          { id: uid(), on: true, tag: "DATA", label: "Résumé Forge",
            text: "Full-stack React + Vite + Express app for tailoring résumés to job descriptions using the Claude API. Features include CV parsing, AI bullet generation, live web search, JD-based bullet matching with honesty controls, multi-template export to PDF and DOCX, drag-and-drop reordering, and a saved-applications library." },
        ],
      },
    ],
  };
