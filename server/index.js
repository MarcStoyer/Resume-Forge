...
app.listen(PORT, () => {
  ...
  if (!API_KEY) console.log("  ⚠  No ANTHROPIC_API_KEY found — AI/web features will return an error until you set it in .env\n");
  else console.log("  ✓  API key loaded. AI + web-search features are live.\n");
});
